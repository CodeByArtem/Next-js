...
export default function CompanyRow({ company }: CompanyRowProps) {
  ...
  return (
    <tr className="h-14 text-center text-gray-900 bg-white">
      <td className="text-xs font-medium text-blue-700 rounded-1 border-blue-700">
      ...
      <td>
        <div className="inline-flex items-center gap-1">
          <Image width={16} height={16} src={`/icon/${company.hasPromotions ? 'check' : 'x-mark'}.svg`} alt="promotion icon" />
